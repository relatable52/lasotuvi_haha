...
<<<<<<< HEAD:lasotuvi_kk/lasotuvi/Sao.py
saoTuongQuan = Sao(31, "Tướng quân", "M", 4)
saoTieuHao = Sao(30, "Tiểu hao", "H", 12)
=======
>>>>>>> 96c671c5b9749f337666d12085ef5a21ec3a3079:lasotuvi_main/lasotuvi/Sao.py
...
saoCoThan = Sao(96, "Cô Thần", "O", 13, dam= True)
saoQuaTu = Sao(97, "Quả Tú", "O", 13, dam = True)
...
DVLocTon = Sao(145, "ĐV.Lộc Tồn", "O", 2)
DVKinh = Sao(146,"ĐV.Kình Dương", "K", 13)
DVDa = Sao(147, "ĐV.Đà La", "K", 13)
saoDaiHao1 = Sao(148,"Đại Hao", "H", 21, tenNamPhai="(Đại Hao)")