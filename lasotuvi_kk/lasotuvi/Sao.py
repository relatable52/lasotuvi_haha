...
saoTieuHao = Sao(30, "Tiểu hao", "H", 12, dam=True)
...
saoDaiHao = Sao(36, "Đại hao", "H", 12, dam=True)
...
saoHuuBat = Sao(62, "Hữu bật", "O", 2, dam=True)
...
# Sao đôi khác
saoThienKhoc = Sao(69, "Thiên khốc", "T", 12, dam=True)
saoThienHu = Sao(70, "Thiên hư", "T", 12, dam=True)
...
saoHoaKhoa = Sao(92, "Hóa khoa", "T", 5, dam=True)
saoHoaQuyen = Sao(93, "Hóa quyền", "T", 4, dam=True)
saoHoaLoc = Sao(94, "Hóa Lộc", "M", 3, dam=True)
...
#Sao Lưu
luuDVLoc = Sao(109, "ĐV.Lộc", "M", 3)
luuDVQuyen = Sao(110, "ĐV.Quyền", "H", 4)
luuDVKhoa = Sao(111, "ĐV.Khoa", "T", 5)
luuDVKy = Sao(112, "ĐV.Kỵ", "T", 13)
luuTVLoc = Sao(113,"LN.Lộc","M", 3)
luuTVQuyen = Sao(114,"LN.Quyền","H", 4)
luuTVKhoa  =Sao(115,"LN.Khoa","M", 5)
luuTVKy = Sao(116,"LN.Kị","T", 13)
...
saoBenhPhu1 = Sao(140, "Bệnh Phù", "H", 21)